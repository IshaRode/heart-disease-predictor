/**
 * GoogleButton — branded Google sign-in/up button.
 * Shows a loading spinner while the OAuth redirect is in progress.
 *
 * Google OAuth setup:
 *  1. Go to console.cloud.google.com → APIs & Services → Credentials
 *  2. Create OAuth 2.0 Client ID (Web application)
 *  3. Add Authorized redirect URI:
 *       https://xatepiatsgkptivpaotx.supabase.co/auth/v1/callback
